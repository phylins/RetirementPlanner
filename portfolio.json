...
function exportCashflowCsv() {
  ...
  downloadCsv('retirement_cashflow_v5_7.csv', headers, rows);
}
function exportDecisionCsv() {
  ...
  downloadCsv('retirement_decision_matrix_v5_7.csv', headers, rows);
}
...
async function init(){
  ...
  // v5.7 fallback for older saved profiles.
  ...
  if ('serviceWorker' in navigator) navigator.serviceWorker.register('./sw.js?v=5.7.0').catch(()=>{});
}
init();

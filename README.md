# Retirement Planner v5.2 PWA

## v5.2 更新重點

- 版本號正式升級為 `v5.2.0`，不再使用 4.x。
...
```html
<!-- Retirement Planner v5.2 root index...
```
...
注意：如果瀏覽器已經儲存過舊設定，且生活費仍為舊版預設 600 萬，v5.2 會自動遷移成 500 萬；若你曾手動改成其他數字則會保留。
